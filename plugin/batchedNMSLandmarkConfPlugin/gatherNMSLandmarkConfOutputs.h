...
pluginStatus_t gatherNMSLandmarkConfOutputs(cudaStream_t stream, bool shareLocation, int numImages, int numPredsPerClass,
    int numClasses, int topK, int keepTopK, DataType DT_BBOX, DataType DT_SCORE, const void* indices,
    const void* scores, const void* bboxData, const void* landData, const void* landConf, void* keepCount,
