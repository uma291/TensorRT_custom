...
class BatchedNMSLandmarkConfPlugin : public IPluginV2Ext
{
public:
    BatchedNMSLandmarkConfPlugin(NMSParameters param);
    BatchedNMSLandmarkConfPlugin(const void* data, size_t length);
    ~BatchedNMSLandmarkConfPlugin() override = default;
...
class BatchedNMSLandmarkConfDynamicPlugin : public IPluginV2DynamicExt
{
public:
    BatchedNMSLandmarkConfDynamicPlugin(NMSParameters param);
    BatchedNMSLandmarkConfDynamicPlugin(const void* data, size_t length);
    ~BatchedNMSLandmarkConfDynamicPlugin() override = default;
...
class BatchedNMSLandmarkConfBasePluginCreator : public BaseCreator
{
public:
    BatchedNMSLandmarkConfBasePluginCreator();
    ~BatchedNMSLandmarkConfBasePluginCreator() override = default;
...
class BatchedNMSLandmarkConfPluginCreator : public BatchedNMSLandmarkConfBasePluginCreator
{
public:
...
class BatchedNMSLandmarkConfDynamicPluginCreator : public BatchedNMSLandmarkConfBasePluginCreator
{
public:
    const char* getPluginName() const noexcept override;
...
#endif // TRT_BATCHED_NMS_LANDMARK_CONF_PLUGIN_H
