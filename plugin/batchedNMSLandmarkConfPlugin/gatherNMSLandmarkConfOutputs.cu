...
static std::array<nmsOutLaunchConfig, 2> nmsOutLCOptions
    = {nmsOutLaunchConfig(DataType::kFLOAT, DataType::kFLOAT, gatherNMSLandmarkConfOutputs_gpu<float, float>),
        nmsOutLaunchConfig(DataType::kHALF, DataType::kHALF, gatherNMSLandmarkConfOutputs_gpu<__half, __half>)};
