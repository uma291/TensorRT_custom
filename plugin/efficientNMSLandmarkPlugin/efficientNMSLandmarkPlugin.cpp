    ...
    int outputIndex, const DimsExprs* inputs, int nbInputs, IExprBuilder& exprBuilder) noexcept
{
    try
    {
        ...
        // Standard NMS
        PLUGIN_VALIDATE(outputIndex >= 0 && outputIndex <= 4);
    ...
    int pos, const PluginTensorDesc* inOut, int nbInputs, int nbOutputs) noexcept
{
    ...
    PLUGIN_VALIDATE(nbInputs == 3 || nbInputs == 4);
    PLUGIN_VALIDATE(nbOutputs == 5);
    if (nbInputs == 3)
    {
        PLUGIN_VALIDATE(0 <= pos && pos <= 7);
    }
    if (nbInputs == 4)
    {
        PLUGIN_VALIDATE(0 <= pos && pos <= 8);
    }
    ...
    const DynamicPluginTensorDesc* in, int nbInputs, const DynamicPluginTensorDesc* out, int nbOutputs) noexcept
{
    try
    {
        ...
        PLUGIN_VALIDATE(in[1].desc.dims.nbDims == 3 || (in[1].desc.dims.nbDims == 4 && in[1].desc.dims.d[3] == 1));
        ...
        PLUGIN_VALIDATE(in[0].desc.dims.nbDims == 3 || in[0].desc.dims.nbDims == 4);
        if (in[0].desc.dims.nbDims == 3)
        {
            PLUGIN_VALIDATE(in[0].desc.dims.d[2] == 4);
        ...
        else
        {
            ...
            PLUGIN_VALIDATE(in[0].desc.dims.d[2] == mParam.numClasses || mParam.shareLocation);
            PLUGIN_VALIDATE(in[0].desc.dims.d[3] == 4);
        ...
        PLUGIN_VALIDATE(in[2].desc.dims.nbDims == 3 || in[2].desc.dims.nbDims == 4);
        if (in[2].desc.dims.nbDims == 3)
        {
            PLUGIN_VALIDATE(in[2].desc.dims.d[2] == 10);
        }
        else
        {
            PLUGIN_VALIDATE(in[2].desc.dims.d[2] == 1);
            PLUGIN_VALIDATE(in[2].desc.dims.d[3] == 10);
        }
        ...
        if (nbInputs == 4)
        {
            ...
            PLUGIN_VALIDATE(in[3].desc.dims.nbDims == 3);
